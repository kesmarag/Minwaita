...
for variant in '' '-Vanilla' '-OSX'; do
sassc -t expanded gtk-3.0/gtk${variant,,}.scss $COMPILED_FOLDER/Minwaita${variant}/Minwaita${variant}/gtk-3.0/gtk.css
  sassc -t expanded gtk-3.0/gtk${variant,,}-dark.scss $COMPILED_FOLDER/Minwaita${variant}/Minwaita${variant}/gtk-3.0/gtk-dark.css
  for color in '-Dark'; do
    sassc -t expanded gtk-3.0/gtk${variant,,}-dark.scss $COMPILED_FOLDER/Minwaita${variant}/Minwaita${variant}${color,}/gtk-3.0/gtk.css
  done
done
